...
excludeFiles = ['bayesys3.c', 'bayesys3.h', 'hilbert.c', 'hilbert.h', 'random.c', 'random.h', 'userstr.h' ]
...
licenseInfo = (
  {'includeFiles':[],
   ...
   'useLicense':'ccpn',
   'programFunction':'Part of the Bayes program',
   'programType':None,
   'stdContact':'ccpn',
   'extraContact':'- contact the author: djo35@bioc.cam.ac.uk',
   'credits':None
  },
)
