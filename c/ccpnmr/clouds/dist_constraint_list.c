...
Dist_constraint_list new_dist_constraint_list(int nconstraints,
	int *atom0, int *atom1, float *dist_lower, float *dist_upper)
{
    int i;
    ...
    {
	dist_constraint = new_dist_constraint(atom0[i], atom1[i],
...
CcpnStatus add_dist_constraint_list(Dist_constraint_list dist_constraint_list,
	int atom0, int atom1, float dist_lower, float dist_upper, CcpnString error_msg)
{
    int n;
