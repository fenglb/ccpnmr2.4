...
licenseInfo = (
  {'includeFiles':['midge.c', 'midge.h'],
   'includeFileMatches':[],
   'format':None,
   'author':'Alexei Grishaev, Miguel Llinas, Guillermo Bermejo, Wayne Boucher and Tim Stevens',
   'organization':'Carnegie Mellon University and University of Cambridge',
   'useLicense':'ccpn',
   'programFunction':'Part of the CcpNmr Clouds program',
   'programType':None,
   'stdContact':'ccpn',
   'extraContact':'- contact: wb104@bioc.cam.ac.uk, tjs23@cam.ac.uk',
   'references':('MIDGE1991', 'CLOUDS2002','CCPNMR2004'),
   'credits':None
  },
  {'includeFiles':['dynamics.c', 'dynamics.h'],
   'includeFileMatches':[],
   'format':None,
   'author':'Alexander Lemak, Miguel Llinas, Wayne Boucher and Tim Stevens',
   'organization':'University of Toronto, Carnegie Mellon University and University of Cambridge',
   'useLicense':'ccpn',
   'programFunction':'Part of the CcpNmr Clouds program',
   'programType':None,
   'stdContact':'ccpn',
  ...
  {'includeFiles':['bacus.c', 'bacus.h'],
   'includeFileMatches':[],
   'format':None,
   'author':'Carlos Steren, Alexei Grishaev, Miguel Llinas, Wayne Boucher and Tim Stevens',
   'organization':'Carnegie Mellon University and University of Cambridge',
   'useLicense':'ccpn',
   'programFunction':'Part of the CcpNmr Clouds program',
   'programType':None,
