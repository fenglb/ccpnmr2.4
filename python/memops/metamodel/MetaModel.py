...
class MetaOperation(HasParameters):
  ...
  def checkValid(self, complete=False):
    ...
    # ops with targetTag != mainOp must replace an autogenerated operation 
    ...
    if targetTag != 'mainOp':
      # only mainOp target is allowed explicit parameters
...
class MetaParameter(AbstractValue):
  ...
  def checkValid(self, complete=False):
    ...
    if operationData[self.container.opType]['targetTag'] == 'mainOp':
