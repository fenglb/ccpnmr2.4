...
from ccpnmr.analysis.core.WindowBasic import getWindowPaneName, getAxisRegionRegion, windowPaneHasValueAxis, isActiveWindow
  ...
  def updateSpectrumTable(self):
    ...
    if windowPane:
      ...
      for spectrumWindowView in spectrumWindowViews:
        ...
        posColors = PrintBasic.getPrintOption(analysisSpectrum, 'PositiveColors', spectrumWindowView.analysisSpectrum.posColors)
        ...
        negColors = PrintBasic.getPrintOption(analysisSpectrum, 'NegativeColors', spectrumWindowView.analysisSpectrum.negColors)
  ...
  def updatePeakListTable(self):
    ...
    if windowPane:
      ...
      for windowPeakList in windowPeakLists:
        ...
        text.append(PrintBasic.getPrintOption(analysisPeakList, 'PeakColor', color))
        textMatrix.append(text)
